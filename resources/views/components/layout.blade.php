...
<html lang="en">
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          <a href="#" class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-search"></i></a>
          <span class="text-white mr-2 header-chat-icon" title="Chat" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-comments"></i></span>
    ...
    <div class="container container--narrow">
      <div class="alert alert-success text-center" style="max-width: 50%; margin: 0 auto;">
        {{session('success')}}
      </div>
    </div>
    @endif
    ...
    <div class="container container--narrow">
      <div class="alert alert-danger text-center" style="max-width: 50%; margin: 0 auto;">
        {{session('error')}}
      </div>
    </div>
    @endif
